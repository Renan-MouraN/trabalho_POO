...
public class Character {
    ...
    public Character(int character_state, double character_X, double character_Y, double character_VX, double character_VY,
    ...
    public double getCharacter_VX(){
        ...
        return this.character_VX;
    }

    public double getCharacter_VY(){

        return this.character_VY;
    }

    public double getCharacter_radius(){

        return this.character_radius;
    }
