...
public class Main {
    ...
    public static void main(String [] args){
        ...
        while(running){
            ...
            for(int i = 0; i < background2.getBackground_X().length; i++){

                GameLib.fillRect(background2.getBackGroundX_value(i), (background2.getBackGroundY_value(i) + background2.getBackground_count()) % GameLib.HEIGHT, 2, 2);
            }
            ...
            for(int i = 0; i < background1.getBackground_X().length; i++){
                ...
                GameLib.fillRect(background1.getBackGroundX_value(i), (background1.getBackGroundY_value(i) + background1.getBackground_count()) % GameLib.HEIGHT, 3, 3);
            }
